...
Invoke-Command -Credential $credentials1 -ComputerName $SiteDetails.Site1SFServer1 -ScriptBlock ${function:FirmBasedMapping} -ArgumentList $SiteDetails.Site1CitrixSiteName,$SiteDetails.Site2CitrixSiteName,$assignedGroup,$GroupSID,"Firm_$assignedGroup"
