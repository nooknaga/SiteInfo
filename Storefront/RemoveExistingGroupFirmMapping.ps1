...
Invoke-Command -Credential $credentials1 -ComputerName $Site1SFServer1 -ScriptBlock ${function:RemoveGroupFirmMapping} -ArgumentList "Firm_$assignedGroup"
#Write-Host Creating Machine Catlaog for $Site2SFServer1 for Group 
#Invoke-Command -Credential $credentials1 -ComputerName $Site2SFServer1 -ScriptBlock ${function:RemoveGroupFirmMapping} -ArgumentList "Firm_$assignedGroup"
